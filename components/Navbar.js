...
export default function Navbar() {
  ...
  return (
    ...
    >
      ...
      <div
        className={`fixed inset-0 z-50 transform bg-midnight text-gold transition-transform transition-opacity duration-600 ease-[cubic-bezier(0.22,0.61,0.36,1)] will-change-transform will-change-opacity ${
          menuOpen
