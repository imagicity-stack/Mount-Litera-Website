  ...
  return (
    <section className="relative overflow-hidden bg-white">
      <div
        ...
        style={{ backgroundImage: "url('/admissions/banner-skyline.jpg')" }}
        aria-hidden="true"
      />
      ...
      <div className="relative max-w-6xl mx-auto px-6 pt-24 pb-16 md:pt-32 md:pb-24">
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-4">
          {trustBadges.map((badge) => (
            ...
            >
              <div className="flex items-center justify-center h-12 w-12 rounded-full bg-cardinal/10 text-black font-semibold text-lg">
                <span className="sr-only">Badge icon</span>
                ★
              </div>
              <div>
                <p className="font-semibold text-black text-lg">{badge.title}</p>
