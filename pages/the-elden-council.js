            ...
            <div className="relative max-w-5xl mx-auto px-6 space-y-12">
              ...
              <div className="grid gap-8 md:grid-cols-4">
                {[{ name: 'Anit Ankur', title: 'Settlor' }, { name: 'Shashi Shankar Prasad', title: 'Managing Trustee' }, { name: 'Vinita Ankur', title: 'Trustee' }, { name: 'Vandana Prasad', title: 'Trustee' }].map((member) => (
                  <div key={member.name} className="overflow-hidden rounded-2xl border border-cardinal/20 bg-white shadow-sm">
                    <div className="flex aspect-[4/5] w-full items-center justify-center bg-cardinal/5 text-cardinal text-sm uppercase tracking-[0.2em]">
                      Image
                    </div>
