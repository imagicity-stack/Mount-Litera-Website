          ...
          <section className="py-16 bg-[#F5F5F5]">
            <div className="max-w-4xl mx-auto px-6 space-y-6">
              ...
              <div className="space-y-4">
                <h2 className="text-2xl font-semibold text-black">Inclusive Access</h2>
              ...
              <div className="space-y-4">
                <h2 className="text-2xl font-semibold text-black">Learning Support</h2>
                <ul className="list-disc list-inside space-y-2 text-gray-700">
              ...
              <div className="space-y-4">
                <h2 className="text-2xl font-semibold text-black">Collaborative Care</h2>
                <ul className="list-disc list-inside space-y-2 text-gray-700">
