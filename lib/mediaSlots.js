...
export const mediaSlots = [
  ...
  {
    key: 'parentRoom.hero',
    group: 'The Parent Room',
    label: 'Parent Room backdrop',
    note: 'Behind the opening headline. Quiet and unposed — a corridor, a doorway, a parent and child. Avoid crowds and avoid anything that reads as an advertisement.',
    ratio: '16/9',
    size: '2400 × 1350',
    ref: '/gallery/DSC04889.jpg',
    alt: 'A quiet moment at The Elden Heights School'
  },
  {
    key: 'parentRoom.counsellor.portrait',
    group: 'The Parent Room',
    label: 'Neha Jain — portrait',
    note: 'Her photograph, shown beside the session details and in the booking panel. Head and shoulders, plain background, eyes to camera. Until an approved photograph is uploaded the page shows her initials rather than a stand-in image — do not upload a stock portrait.',
    ratio: '3/4',
    size: '900 × 1200',
    // Intentionally empty: there is no approved photograph in the repository,
    // and a substitute face on a page about trust would be the wrong default.
    ref: '',
    alt: 'Neha Jain, Director, Institutional Wellbeing & Strategic Advisory'
  }
];
