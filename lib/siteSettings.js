...
export const defaultSettings = {
  ...
  addressLine2: 'Hazaribagh, Jharkhand – 825301',
  // The footer shows this one, not the two lines above, so it carries the
  // pincode of its own accord rather than inheriting it.
  region: 'Hazaribagh, Jharkhand – 825301 · India',
...
export const settingsFields = [
  ...
  { group: 'Address', name: 'addressLine1', label: 'Address line 1', hint: 'Street and locality. Shown on the contact page.' },
  { group: 'Address', name: 'addressLine2', label: 'Address line 2', hint: 'City, state and pincode. Shown on the contact page.' },
  {
    group: 'Address',
    name: 'region',
    label: 'Short location',
    hint: 'The one line under “Location” in the footer — it is separate from the two lines above, so include the pincode here too.'
  },
